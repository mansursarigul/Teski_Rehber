...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapter(Context context, List<String> listDataGroup,
                                     HashMap<String, List<AdSoyadMobil>> listChildData) {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        final AdSoyadMobil childText = (AdSoyadMobil) getChild(groupPosition, childPosition);
        ...
        TextView textViewChild2 = convertView
                .findViewById(R.id.textViewChild2);

        textViewChild.setText(childText.getName());
        textViewChild2.setText(childText.getCode());
        return convertView;
    }
